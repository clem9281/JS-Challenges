...
// const arr = ["This", "is", "an", "example", "of", "text", "justification."];
// textJustification(arr, 16).forEach(el => console.log(`|${el}|`));

// const arr1 = ["Two", "words."];
// textJustification(arr1, 11).forEach(el => console.log(`|${el}|`));

// const arr2 = ["Two", "words."];
// textJustification(arr2, 10).forEach(el => console.log(`|${el}|`));

// const arr3 = ["a", "b", "c", "longword"];
// textJustification(arr3, 9).forEach(el => console.log(`|${el}|`));

// const arr4 = ["Two", "words."];
// textJustification(arr4, 9).forEach(el => console.log(`|${el}|`));

// const arr5 = ["Looks", "like", "it", "can", "be", "a", "tricky", "test"];
// textJustification(arr5, 25).forEach(el => console.log(`|${el}|`));
...
//   "zzz"
// ];
// textJustification(arr6, 8).forEach(el => console.log(`|${el}|`));
